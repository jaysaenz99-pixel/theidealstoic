...
export function welcomeText() {
  return [
    ...
    "Epictetus perceived in fragments, Christ embodied completely. That is the",
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background:${IVORY};">
  ...
  <tr>
    <td style="padding:24px 40px 0;">
      ...
      <p style="margin:0 0 20px;font-family:${SERIF};font-size:17px;line-height:1.7;color:${INK};">The Stoics taught that wisdom, courage, temperance, and justice could anchor the soul through any storm. What Marcus Aurelius, Seneca, and Epictetus perceived in fragments, Christ embodied completely. That is the argument of the book, and I am glad you want to follow it.</p>
    </td>
  </tr>
