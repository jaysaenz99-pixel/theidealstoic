...
export function welcomeText() {
  return [
    ...
    CHAPTER_URL,
    "",
    "Christ the Ideal Stoic does not have a publication date yet. You'll",
    "hear from me when it does, and now and then afterwards, never often,",
    "and never with anything I wouldn't want to read myself.",
    "",
...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;">Stoicism gives us a vision. Christ gives us a face.</div>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background:${IVORY};">
  ...
  <tr>
    <td style="padding:44px 40px 8px;">
      <div style="font-family:${SANS};font-size:11px;font-weight:600;letter-spacing:3px;text-transform:uppercase;color:${STONE};">Before publication</div>
  ...
  <tr>
    <td style="padding:24px 40px 0;">
      ...
      <p style="margin:0 0 20px;font-family:${SERIF};font-size:17px;line-height:1.7;color:${INK};"><em>Christ the Ideal Stoic</em> does not have a publication date yet. You&rsquo;ll hear from me when it does, and now and then afterwards, never often, and never with anything I wouldn&rsquo;t want to read myself.</p>
