...
export function welcomeText() {
  return [
    ...
    CHAPTER_URL,
    "",
    "Christ the Ideal Stoic is published on January 19, 2027. You'll hear",
...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;">Published January 19, 2027. Stoicism gives us a vision. Christ gives us a face.</div>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background:${IVORY};">
  ...
  <tr>
    <td style="padding:44px 40px 8px;">
      <div style="font-family:${SANS};font-size:11px;font-weight:600;letter-spacing:3px;text-transform:uppercase;color:${STONE};">Before January 19</div>
  ...
  <tr>
    <td style="padding:24px 40px 0;">
      ...
      <p style="margin:0 0 20px;font-family:${SERIF};font-size:17px;line-height:1.7;color:${INK};"><em>Christ the Ideal Stoic</em> is published on <strong style="font-weight:normal;color:${NAVY};">January 19, 2027</strong>. You&rsquo;ll hear from me then, and now and then afterwards, never often, and never with anything I wouldn&rsquo;t want to read myself.</p>
